...
public class MeetOurArtists3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.meet_our_artists3);
    ...
    public void addToCartUrban(View view) {
        CartManager.getInstance().addItem("Urban Stories");
        Toast.makeText(this, "Urban Stories added to cart", Toast.LENGTH_SHORT).show();
        startActivity(new Intent(this, ShoppingCart.class));
    }

    public void addToCartRecycled(View view) {
        CartManager.getInstance().addItem("Recycled Beauty");
        Toast.makeText(this, "Recycled Beauty added to cart", Toast.LENGTH_SHORT).show();
        startActivity(new Intent(this, ShoppingCart.class));
    }
